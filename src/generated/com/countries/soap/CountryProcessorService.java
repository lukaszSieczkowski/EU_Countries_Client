...
@WebServiceClient(name = "CountryProcessorService", 
                  wsdlLocation = "file:/D:/Ĺ�ukasz/JAVA/MOJE%20PROJEKTY/EU_Countries_Client/src/main/resources/EU_Countries_Client.wsdl",
...
public class CountryProcessorService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Ĺ�ukasz/JAVA/MOJE%20PROJEKTY/EU_Countries_Client/src/main/resources/EU_Countries_Client.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountryProcessorService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/Ĺ�ukasz/JAVA/MOJE%20PROJEKTY/EU_Countries_Client/src/main/resources/EU_Countries_Client.wsdl");
        }
        WSDL_LOCATION = url;
    }
